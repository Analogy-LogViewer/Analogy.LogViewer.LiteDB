...
{
    public class LiteDBDownloadInformation : Template.AnalogyDownloadInformation
    {
        public override Guid FactoryId { get; set; } = PrimaryFactory.Id;
        public override string Name { get; set; } = "Analogy LiteDB db browser";
        ...
        protected override string RepositoryURL { get; set; } = "https://api.github.com/repos/Analogy-LogViewer/Analogy.LogViewer.LiteDB";
    }
}